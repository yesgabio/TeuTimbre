...
const models = [require("../models/user.model"), require("../models/product.model"), require("../models/acervouser.model"), require("../models/admuser.model")];
